...
# coding=utf-8
# Adapted from 2024 The Qwen team, Alibaba Group and the HuggingFace Inc. team. All rights reserved.
#
...
import torch
import transformers
from penguinvl.model.penguinvl_encoder import PenguinVLImageProcessor
from transformers.feature_extraction_utils import BatchFeature
from transformers.image_utils import ImageInput
from transformers.processing_utils import ProcessingKwargs, ProcessorMixin, Unpack
from transformers.tokenization_utils_base import PreTokenizedInput, TextInput

from penguinvl.constants import DEFAULT_IMAGE_TOKEN, IGNORE_INDEX
from penguinvl.mm_utils import load_video, load_images
from penguinvl.model.penguinvl_encoder.image_processing_penguinvl import is_valid_image, is_valid_video
...
def _custom_import(class_name: str):
    try:
        ...
        if "image" in class_name.lower():
            attribute_class = PenguinVLImageProcessor
...
class PenguinVLBaseProcessor(ProcessorMixin, metaclass=ABCMeta):
    r"""
    ...
    def process_images(
        ...
        **kwargs,
        ...
        if images is None:
            return {}
        image_inputs = self.image_processor(images=images, merge_size=merge_size, frame_types=frame_types, **kwargs)
        return image_inputs
    ...
    def __call__(
        ...
        **kwargs: Unpack[PenguinVLProcessorKwargs],
        ...
        image_inputs = self.process_images(images, merge_size, frame_types, **output_kwargs["images_kwargs"])
