...
from .model.processor import PenguinVLBaseProcessor
...
def model_init(model_path=None, min_visual_tokens=None, max_visual_tokens=None, **kwargs):
    model_path = "tencent/PenguinVL-7B" if model_path is None else model_path
    ...
    if min_visual_tokens is not None:
        processor.image_processor.min_tokens = min_visual_tokens
